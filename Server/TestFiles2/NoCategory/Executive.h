...
namespace CodeAnalysis
{
	...
	public:
		...
		std::string ExePath();
		void processcppHeader(bool showProc);
		void processcppImp(bool showProc);
		std::string putHyphens();
		std::unordered_map <std::string, std::vector<std::pair<int, int>>> getnamespace();
		//std::unordered_map <std::string, std::vector<std::pair<int, int>>> getLineTable();
	private:
		...
		std::unordered_map <std::string, std::vector<std::pair<int, int>>> getLineTable(ASTNode* root);
