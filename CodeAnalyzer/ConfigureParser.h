...
namespace CodeAnalysis
{
	...
	private:
		...
		HandleEndScope* pHandleEndScope = nullptr;		PreprocStatement* pPreprocStatement = nullptr;
		HandlePreprocStatement* pHandlePreprocStatement = nullptr;		NamespaceDefinition* pNamespaceDefinition = nullptr;
		HandleNamespaceDefinition* pHandleNamespaceDefinition = nullptr;		ClassDefinition* pClassDefinition = nullptr;
		HandleClassDefinition* pHandleClassDefinition = nullptr;		StructDefinition* pStructDefinition = nullptr;
		HandleStructDefinition* pHandleStructDefinition = nullptr;		
		//TypeDefinition* pTypeDefinition = nullptr;
		//HandleTypeDefDefinition* pHandleTypeDefDefinition = nullptr;		UsingDefinition* pUsingDefinition = nullptr;
		//HandleUsingDefinition* pHandleUsingDefinition = nullptr;		EnumDefinition* pEnumDefinition = nullptr;
		//HandleEnumDefinition* pHandleEnumDefinition = nullptr;		
		CppFunctionDefinition* pCppFunctionDefinition = nullptr;
		HandleCppFunctionDefinition* pHandleCppFunctionDefinition = nullptr;	//PrintFunction* pPrintFunction;
